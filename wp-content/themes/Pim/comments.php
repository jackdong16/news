...
if( have_comments() ) : ?> 
					...
					<h5 class="cufon"><?php comments_number('No comment', 'Comment', '% Comments'); ?> for <?php the_title(); ?></h5><hr/>

					<?php wp_list_comments( array('callback' => 'peerapong_comment', 'avatar_size' => '40') ); ?>
