...
$theme_sidebar = array('-- Select sidebar --','Page Sidebar', 'Contact Sidebar');
$dynamic_sidebar = get_option('nm_sidebar');
...
function page_create_meta_box() {
	...
	if ( function_exists('add_meta_box') && isset($page_postmetas) && count($page_postmetas) > 0 ) {  
		add_meta_box( 'page_metabox', 'Pim Page Options', 'page_new_meta_box', 'page', 'normal', 'high' );  
	}
