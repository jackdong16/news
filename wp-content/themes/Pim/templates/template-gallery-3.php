															...
															<div class="one_third<?php echo $last_class?>">
																<div class="gallery_image">
																	<a href="<?php echo $image_url?>" class="portfolio_image">
																		<img src="<?php bloginfo( 'stylesheet_directory' ); ?>/timthumb.php?src=<?php echo $image_url?>&h=182&w=250&zc=1<?php echo $image_url?>" alt="" class="frame"/>
																	</a>
																	
																	<span class="gallery3_hover">
